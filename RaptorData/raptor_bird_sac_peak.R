...
raptor_bird_data_with_weather_info <- inner_join(raptor_bird_data_full, weather_data, by = c("Time", "Year", "Month", "Day"))

# Create a subset of raptor data for August to October
raptor_bird_data_subset <- raptor_bird_data_with_weather_info %>%
